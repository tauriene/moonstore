    ...
    <header className={isSearchExpanded ? 'search-expanded' : ''}>
      ...
      <div className={`header-actions ${isSearchExpanded ? 'hidden' : ''}`}>
        <div className="header-phone">
          <a href="tel:88005501900">+7 (800) 550-19-00</a>
          <span>Ежедневно · Круглосуточно</span>
        </div>

        <a href="https://t.me/moonstoremoskwa_bot" target="_blank" rel="noopener noreferrer" style={{ textDecoration: 'none' }} className="action-telegram">
